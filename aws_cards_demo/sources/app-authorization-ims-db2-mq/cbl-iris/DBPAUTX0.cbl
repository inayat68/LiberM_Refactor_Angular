      ...
      ******************************************************************
      *
      * Description: I/O ROUTINE FOR DBD: DBPAUTX0
      *
      ******************************************************************
      *
      ...
      *
       ...
       01 SEGMENTS-LAST-AREA.
         ...
         03 PAUTINDX-LAST-AREA               PIC X(6).
       01 WS-SEGMENTS-AREA.
         03 PAUTSUM0-AREA               PIC X(100).
         03 PAUTDTL1-AREA               PIC X(200).
         03 PAUTINDX-AREA               PIC X(6).
       ...
       01 PAUTINDX-SSA.
         03  FILLER                   PIC X(19)
             VALUE 'PAUTINDX(ACCNTID ='.
         03  PAUTINDX-KEY                PIC X(6).
         03  FILLER                   PIC X(2)  VALUE ') '.
       01 PAUTINDX-SSA-UNQ.
         03  FILLER                   PIC X(9)
             VALUE 'PAUTINDX '.
      ...
      *
      *    LOGICAL SEGMENTS TO ACCESS TO PHYSICAL SEGMENTS
      *
       01 LG-RTN-USED-KEYS-AREA.
         03 LG-RTN-FB-KEY-MAX-LENGTH           PIC S9(9) COMP.
         03 LG-RTN-USED-KEY-SECONDARY          PIC X(255).
         03 LG-RTN-USED-KEY-GNUNQ-NEXT-SEG     PIC X(8).
         03 LG-RTN-USED-KEY-GNUNQ-SAVE-POS     PIC X(512).
         03 LG-RUN-DBD-STATUS                  PIC S9(4) COMP.
         03 LG-RUN-IMS-DUAL-POINTER            POINTER.
         03 LG-RUN-PCB-INDEX                   PIC 9(3).
         03 LG-RUN-IO-AREA-PTR                 POINTER.
         03 LG-INIT-DBD-STATUS                 PIC S9(4) COMP.
         03 FILLER                             PIC X(206).
         03 LG-RTN-USED-KEY-VALUE OCCURS 8.
           05 LG-RTN-USED-SSA-INFO             PIC X(1055).
           05 LG-RTN-USED-KEY-STATUS           PIC X.
             88 LG-RTN-USED-KEY-NOT-CHANGED    VALUE '0' X'00' ' '.
             88 LG-RTN-USED-KEY-CHANGED        VALUE '1'.
             88 LG-RTN-USED-KEY-IS-INDEX       VALUE '2'.
             88 LG-RTN-USED-KEY-DUPREC         VALUE '3'.
           05 LG-RTN-USED-SSA-KEYS.
             07 LG-RTN-USED-KEY-ALPHA          PIC X(256).
             07 LG-RTN-USED-KEY-PACKED REDEFINES LG-RTN-USED-KEY-ALPHA
                                               PIC S9(18) COMP-3.
             07 LG-RTN-USED-KEY-NUMERIC        PIC S9(9) COMP.
             07 LG-RTN-USED-KEY-NUMERIC-PREV   PIC S9(9) COMP.
             07 LG-RTN-USED-KEY-NUMERIC-NEXT   PIC S9(9) COMP.
             07 LG-RTN-USED-KEY-PARENT-ALPHA   PIC X(256).
             07 LG-RTN-USED-KEY-PARENT-NUMERIC PIC S9(9) COMP.
      *
      *   SYSTEM FIELDS STORAGE
      *
             07 FILLER OCCURS 32.
               09 LG-RTN-USED-KEY-LAST-SX      PIC S9(9) COMP.
             07 LG-RTN-USED-LAST-SEGMENT       PIC X(8).
             07 LG-RTN-LAST-OPEN-CURSOR        PIC 9(8).
             07 FILLER                         PIC X(272).
      *    FEED-BACK KEY LENGTH FOR LOGICAL ACCESS
       01 LG-FB-KEY-LENGTH                     PIC S9(9) COMP.
       01 LG-IO-AREA                           PIC X(32000).
       01 LG-FB-KEY-AREA                       PIC X(32000).
       01 LG-IO-AREA-POS                       PIC S9(9) COMP.
       01 LG-FB-KEY-AREA-POS                   PIC S9(9) COMP.
      ...
      *
       ...
       01 WS-DBD-NAME                   PIC X(8)  VALUE 'DBPAUTX0'.
      ...
      *    IRIS GLOBAL AREA
      *
           COPY IRISGLOB REPLACING ==:PROGNM:== BY =='DBPAUTX0'==.
      *
      *    IRIS PCB AREA
      *
           COPY IRISPCB.
           ...
           07 IO-RTN-USED-KEY-VALUE OCCURS 10.
             ...
             09 IO-RTN-USED-SSA-INPUT-KEYS       REDEFINES
               ...
               11 IO-RTN-IRIS-KEYVALUES          OCCURS 16.
                 ...
                 13 IO-RTN-IRIS-KEYVALUE-PACKED  REDEFINES
                    IO-RTN-IRIS-KEYVALUE         PIC S9(18) COMP-3.
             ...
             09 IO-RTN-USED-SSA-KEYS.
               ...
               11 IO-RTN-USED-KEY-PACKED REDEFINES IO-RTN-USED-KEY-ALPHA
                                                 PIC S9(18) COMP-3.
      ...
      *
           ...
           OR IRIS-TRACE-PERFORMANCE
             MOVE 1 TO IRIS-MSG-LEN
             STRING '<IRISTRACE> - DBPAUTX0:START' NL
                    ' DBD        =(DBPAUTX0) ' NL
      ...
      *
             WHEN 'PAUTINDX'
      *
               PERFORM HANDLE-SEGMENT-PAUTINDX
      *
             WHEN OTHER
      ...
      *
           IF IRIS-TRACE-STANDARD
             ...
             IF NOT IRIS-SQL-OK AND NOT IRIS-SQL-NOT-FOUND
               ...
               STRING '<IRISTRACE> - DBPAUTX0:SQL_RC' NL
             ...
             IF IRIS-NO-ERROR AND IRIS-TRACE-FULL
               STRING '<IRISTRACE> - DBPAUTX0:END' NL
                      ' DBD        =(DBPAUTX0) ' NL
                      ' CALLER PGM =(' IRIS-PROGRAM-NAME ') ' NL
                      ' CALLER ID  =(' IRIS-CALL-ID ') ' NL
...
NODUAL*    PERFORM BUILD-SSAS
      ...
      *
           ...
           WHEN 'PAUTINDX'
             MOVE PAUTINDX-LVL TO WS-INIT-SEGMENT-LEVEL
           END-EVALUATE
      ...
      *
           ...
           IF SQLCODE = ZERO
             MOVE SPACE TO IO-RTN-USED-KEY-SECONDARY
             MOVE KEY-ACCNTID OF PAUTSUM0(1:6) 
                                       TO IO-RTN-USED-KEY-SECONDARY
      ...
      *
           MOVE IO-RTN-USED-KEY-SECONDARY TO KEY-ACCNTID OF PAUTSUM0
           IF KEY-ACCNTID OF PAUTSUM0 NOT NUMERIC
             MOVE ZERO
                                               TO WS-PACKED-FLD-18-00(2)
           ELSE
      ...
      *
           ...
           IF WS-WHERE-LEN > 0
             ...
             IF IRIS-TRACE-FULL
               MOVE 0 TO IRIS-MSG-LEN
               STRING '<IRISTRACE> - DBPAUTX0:SELECT-DYNAMIC' NL
      ...
      *
           IF SQLCODE = ZERO
             MOVE KEY-ACCNTID OF PAUTSUM0
             TO WS-PACKED-FLD-18-00(1)
             MOVE WS-PACKED-FLD-CHR(1)(1:6)
             TO IO-RTN-USED-KEY-SECONDARY(1:6)
           END-IF
      *
      * PACKED FIELDS VS SIGNED ZONED FITTING
      *
      ...
      *
           ...
           INTO WS-SQL-STM-TXT POINTER WS-SQL-STM-LEN
           IF SQL-JOIN-CLAUSE-LENGTH > 0
             STRING 'DBPAUTP0_PAUTSUM0.KEY_ACCNTID, '
             DELIMITED BY SIZE
             INTO WS-SQL-STM-TXT POINTER WS-SQL-STM-LEN
           ELSE
             STRING '''NULL'', '
      ...
      *      STORE THE SECONDARY INDEX JUST READ
             INSPECT WS-WHERE TALLYING WS-INDEX FOR
             ALL 'KEY_ACCNTID'
             IF WS-INDEX > 0
               MOVE KEY-ACCNTID OF PAUTSUM0
                 TO WS-PACKED-FLD-18-00(1)
      ...
      ******************************************************************
      *
       HANDLE-SEGMENT-PAUTINDX SECTION.
      *
           MOVE PAUTINDX-LVL TO WS-SEGMENT-LEVEL
           MOVE PAUTINDX-LEN TO WS-SEGMENT-LEN WS-INIT-PATHCALL-LEN
      *
           MOVE 'HANDLE-SEGMENT-PAUTINDX' TO WS-LAST-IORTN-SECTION
      *
           EVALUATE TRUE
           WHEN SQL-SELECT-PRIMARY
             PERFORM PAUTINDX-SELECT-PRIMARY-KEY
           WHEN SQL-SELECT-SEEK
             SET COMMAND-CODE-FIRST TO TRUE
             EVALUATE TRUE
             WHEN  IRIS-CODE-FIRST(1)
      ...
      *
           ...
           WHEN SQL-SELECT-DYNAMIC
             ...
             END-EVALUATE
      *
             PERFORM PAUTINDX-SELECT-DYNAMIC
           WHEN SQL-SELECT-PATH
             SET COMMAND-CODE-FIRST TO TRUE
             EVALUATE TRUE
             WHEN  IRIS-CODE-FIRST(1)
      ...
      *
           ...
           WHEN SQL-INSERT
             ...
             END-EVALUATE
      *
             PERFORM PAUTINDX-INSERT
           WHEN SQL-UPDATE
             PERFORM PAUTINDX-UPDATE
           WHEN SQL-DELETE
             PERFORM PAUTINDX-DELETE
           WHEN OTHER
             SET IRIS-ERR-FUNCTION-NOT-FOUND TO TRUE
           END-EVALUATE
      *
           IF IRIS-SQL-OK
             MOVE PAUTINDX-LVL TO WS-LAST-SEGMENT-LEVEL
             MOVE 'PAUTINDX' TO WS-LAST-SEGMENT-NAME
           END-IF.
      *
       HANDLE-SEGMENT-PAUTINDX-EX.
      *
           EXIT.
      *
      ******************************************************************
      ...
      ******************************************************************
      *
       PAUTINDX-SELECT-PRIMARY-KEY SECTION.
      *
           MOVE 'PAUTINDX-SELECT-PRIMARY-KEY' TO WS-LAST-IORTN-SECTION
      *
           IF KEY-ACCNTID OF PAUTSUM0 NOT NUMERIC
             MOVE ZERO
                                               TO WS-PACKED-FLD-18-00(2)
           ...
           COMPUTE WS-CK-LEN = 6
           MOVE WS-PACKED-FLD-CHR(2)(5:6)
                    TO PAUTINDX-CONCATENATED-KEY(WS-CK-POS:WS-CK-LEN)
           ADD WS-CK-LEN TO WS-CK-POS
           MOVE IO-RTN-USED-KEY-ALPHA(1)(1:6)
                            TO WS-PACKED-FLD-CHR(1)(5:6)
           IF WS-PACKED-FLD-18-00(1) NOT NUMERIC
           ...
           KEY_ACCNTID =
                      :PAUTSUM0.KEY-ACCNTID
             ORDER BY KEY_ACCNTID
             FETCH FIRST 1 ROWS ONLY
           END-EXEC
      *
           SET IO-RTN-USED-KEY-NOT-CHANGED(PAUTINDX-LVL) TO TRUE
           MOVE SQLCODE TO IRIS-DB-SQLCODE
           IF SQLCODE = ZERO
             MOVE KEY-ACCNTID OF PAUTSUM0 TO WS-PACKED-FLD-18-00(1)
             MOVE WS-PACKED-FLD-CHR(1)(5:6)
             ...
             MOVE WS-PACKED-FLD-CHR(1)(5:6)
                                                  TO WS-FB-KEY-AREA(1:6)
             MOVE 6 TO WS-FB-KEY-LENGTH
             MOVE PAUTINDX-LEN TO WS-SEGMENT-LEN
             PERFORM PAUTINDX-SET-IO-AREA
             SET IO-RTN-USED-KEY-CHANGED(PAUTINDX-LVL) TO TRUE
             MOVE 'PAUTINDX' TO WS-LAST-SEGMENT-NAME
                             IO-RTN-USED-LAST-SEGMENT(PAUTINDX-LVL)
           END-IF
      *
           MOVE SQLCODE TO IRIS-SQLCODE IRIS-DB-SQLCODE
           MOVE SQLERRM TO IRIS-SQLERRM.
      *
       PAUTINDX-SELECT-PRIMARY-KEY-EX.
           EXIT.
      *
      ******************************************************************
      ...
      ******************************************************************
      *
       PAUTINDX-SELECT-FIRST SECTION.
      *
           MOVE 'PAUTINDX-SELECT-FIRST' TO WS-LAST-IORTN-SECTION
      *
           IF KEY-ACCNTID OF PAUTSUM0 NOT NUMERIC
             MOVE ZERO
                                               TO WS-PACKED-FLD-18-00(2)
      ...
      ******************************************************************
      *
       PAUTINDX-SELECT-NEXT SECTION.
      *
           MOVE 'PAUTINDX-SELECT-NEXT' TO WS-LAST-IORTN-SECTION
      *
           IF KEY-ACCNTID OF PAUTSUM0 NOT NUMERIC
             MOVE ZERO
                                               TO WS-PACKED-FLD-18-00(2)
      ...
      ******************************************************************
      *
       PAUTINDX-SELECT-DYNAMIC SECTION.
      *
           MOVE 'PAUTINDX-SELECT-DYNAMIC' TO WS-LAST-IORTN-SECTION
      *
           IF KEY-ACCNTID OF PAUTSUM0 NOT NUMERIC
             MOVE ZERO
                                               TO WS-PACKED-FLD-18-00(2)
      ...
      *
           ...
           END-IF
      *
           MOVE ' ORDER BY KEY_ACCNTID ' TO WS-ORDERBY
           COMPUTE WS-ORDERBY-LEN = 22
           IF COMMAND-CODE-LAST
             STRING WS-ORDERBY(1:WS-ORDERBY-LEN)
             ' DESC ' DELIMITED BY SIZE
             INTO WS-ORDERBY
      ...
      *
           ...
           IF WS-WHERE-LEN > 0
             ...
             IF IRIS-TRACE-FULL
               MOVE 0 TO IRIS-MSG-LEN
               STRING '<IRISTRACE> - DBPAUTX0:SELECT-DYNAMIC' NL
                    ' SECTION    =(PAUTINDX-SELECT-DYNAMIC) ' NL
                    ' CONDITION  =(' WS-WHERE(1:WS-WHERE-LEN) ')' NL
                    ' ORDER BY   =(' WS-ORDERBY(1:WS-ORDERBY-LEN) ')'
               MESSAGE-END DELIMITED BY SIZE INTO IRIS-MSG-TXT
               SET IRISTRAC-RTN TO TRUE
      ...
      *
           EXEC SQL
             DECLARE PAUTINDX_CRS CURSOR
             FOR PAUTINDX_STATEMENT
           END-EXEC
      *
      *    DECLARE THE SQL STATEMENT
      *
           EXEC SQL
             DECLARE PAUTINDX_STATEMENT STATEMENT
           END-EXEC
      *
      *    PREPARE THE STATEMENT
      *
           EXEC SQL
             PREPARE PAUTINDX_STATEMENT
             INTO :SQLDA
             FROM :WS-SQL-STM
           END-EXEC
      *
      ...
      *
           IF SQLCODE NOT = ZERO
             MOVE SQLCODE TO IRIS-SQLCODE IRIS-DB-SQLCODE
             MOVE SQLERRM TO IRIS-SQLERRM
             GO TO PAUTINDX-SELECT-DYNAMIC-EX
           END-IF
      *
      *    OPEN THE DYNAMIC CURSOR
      *
      ...
      ******************************************************************
      *
       PAUTINDX-INSERT SECTION.
      *
           MOVE 'PAUTINDX-INSERT' TO WS-LAST-IORTN-SECTION
      *
           SET IRIS-ERR-WRONG-ALT-INDEX TO TRUE.
      *
       PAUTINDX-INSERT-EX.
           EXIT.
      *
      ...
      ******************************************************************
      *
       PAUTINDX-UPDATE SECTION.
      *
           MOVE 'PAUTINDX-UPDATE' TO WS-LAST-IORTN-SECTION
      *
           SET IRIS-ERR-WRONG-ALT-INDEX TO TRUE.
      *
       PAUTINDX-UPDATE-EX.
      ...
      ******************************************************************
      *
       PAUTINDX-DELETE SECTION.
      *
           MOVE 'PAUTINDX-DELETE' TO WS-LAST-IORTN-SECTION
      *
           SET IRIS-ERR-WRONG-ALT-INDEX TO TRUE.
      *
       PAUTINDX-DELETE-EX.
      ...
      ******************************************************************
      *
       PAUTINDX-SET-IO-AREA SECTION.
      *
           MOVE 'PAUTINDX-SET-IO-AREA' TO WS-LAST-IORTN-SECTION
      *
           MOVE KEY-ACCNTID OF PAUTSUM0
             TO WS-PACKED-FLD-18-00(1)
           MOVE WS-PACKED-FLD-CHR(1)(1:WS-SEGMENT-LEN)
                     TO LK-IO-AREA(1:WS-SEGMENT-LEN).
      *
       PAUTINDX-SET-IO-AREA-EX.
           EXIT.
      *
      *
      ******************************************************************
