...
IRISDB     COPY IRISGLOB REPLACING ==:PROGNM:== BY =='COPAUS0C'==.
...
IRISDB*    EXEC DLI GNP USING PCB(PAUT-PCB-NUM)                         LN461
IRISDB*        SEGMENT (PAUTDTL1)                                       LN462
IRISDB*        INTO (PENDING-AUTH-DETAILS)                              LN463
IRISDB*    END-EXEC                                                     LN464
...
IRISDB*    EXEC DLI GNP USING PCB(PAUT-PCB-NUM)                         LN493
IRISDB*        SEGMENT (PAUTDTL1)                                       LN494
IRISDB*        INTO (PENDING-AUTH-DETAILS)                              LN495
IRISDB*        WHERE (PAUT9CTS = PA-AUTHORIZATION-KEY)                  LN496
IRISDB*    END-EXEC                                                     LN497
...
IRISDB*    EXEC DLI GU USING PCB(PAUT-PCB-NUM)                          LN973
IRISDB*        SEGMENT (PAUTSUM0)                                       LN974
IRISDB*        INTO (PENDING-AUTH-SUMMARY)                              LN975
IRISDB*        WHERE (ACCNTID = PA-ACCT-ID)                             LN976
IRISDB*    END-EXEC                                                     LN977
...
IRISDB                            PENDING-AUTH-SUMMARY
      ...
      *****************************************************************
       SCHEDULE-PSB.
IRISDB*    EXEC DLI SCHD                                                LN1002
IRISDB*         PSB((PSB-NAME))                                         LN1003
IRISDB*         NODHABEND                                               LN1004
IRISDB*    END-EXEC                                                     LN1005
...
IRISDB*       EXEC DLI TERM                                             LN1008
IRISDB*       END-EXEC                                                  LN1009
...
IRISDB*       EXEC DLI SCHD                                             LN1011
IRISDB*            PSB((PSB-NAME))                                      LN1012
IRISDB*            NODHABEND                                            LN1013
IRISDB*       END-EXEC                                                  LN1014
