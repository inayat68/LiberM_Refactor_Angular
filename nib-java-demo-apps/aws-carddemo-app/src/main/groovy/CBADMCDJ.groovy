...
exec "STEP1", pgm: "DFHCSDUP", parm: "CSD(READWRITE),PAGESIZE(60),NOCOMPAT", {
    // dd "STEPLIB", // dsn: "OEM.CICSTS.V05R06M0.CICS.SDFHLOAD", disp: SHR
    dd "DFHCSD", dsn: "OEM.CICSTS.DFHCSD", disp: SHR
    dd "OUTDD", sysout: "*"
    dd "SYSPRINT", sysout: "*"
