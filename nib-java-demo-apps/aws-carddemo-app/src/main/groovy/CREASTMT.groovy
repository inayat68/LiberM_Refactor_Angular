...
exec "STEP010", pgm: "SORT", parm: "verbose", {
    dd "SORTIN", dsn: "AWS.M2.CARDDEMO.TRANSACT.VSAM.KSDS", disp: SHR
    dd "SYSPRINT", sysout: "*"
    dd "SYSOUT", sysout: "*"
    dd "SORTOUT", dsn: "AWS.M2.CARDDEMO.TRXFL.SEQ", disp: [NEW,CATLG,DELETE], lrecl: 350, recfm: FB
    // Instream content is expanded below
    dd "SYSIN", instream: [
    "  SORT FIELDS=(263,16,CH,A,1,16,CH,A)",
    "  OUTREC FIELDS=(1:263,16,17:1,262,279:279,50)"
...
exec "STEP020", pgm: "IDCAMS", cond: [0,NE], {
    dd "SYSPRINT", sysout: "*"
    dd "INFILE", dsn: "AWS.M2.CARDDEMO.TRXFL.SEQ", disp: SHR
    dd "OUTFILE", dsn: "AWS.M2.CARDDEMO.TRXFL.VSAM.KSDS", disp: SHR
    // Instream content is expanded below
    dd "SYSIN", instream: [
    "  REPRO INFILE(INFILE) OUTFILE(OUTFILE)"
    ]
...
exec "STEP030", pgm: "IEFBR14", cond: [0,NE], {
    dd "HTMLFILE", dsn: "AWS.M2.CARDDEMO.STATEMNT.HTML", disp: [MOD,DELETE,DELETE], lrecl: 80, recfm: FB
    dd "STMTFILE", dsn: "AWS.M2.CARDDEMO.STATEMNT.PS", disp: [MOD,DELETE,DELETE], lrecl: 80, recfm: FB
}
...
exec "STEP040", pgm: "CBSTM03A", cond: [0,NE], {
    // dd "STEPLIB", // dsn: "AWS.M2.CARDDEMO.LOADLIB", disp: SHR
    dd "SYSPRINT", sysout: "*"
    dd "SYSOUT", sysout: "*"
    dd "TRNXFILE", dsn: "AWS.M2.CARDDEMO.TRXFL.VSAM.KSDS", disp: SHR
    ...
    dd "STMTFILE", dsn: "AWS.M2.CARDDEMO.STATEMNT.PS", disp: [NEW,CATLG,DELETE], lrecl: 80, recfm: FB
    dd "HTMLFILE", dsn: "AWS.M2.CARDDEMO.STATEMNT.HTML", disp: [NEW,CATLG,DELETE], lrecl: 100, recfm: FB
}
