...
import com.aws.carddemo.common.copybook.Cvtra02y;
import com.aws.carddemo.common.copybook.Cvtra05y;
import com.nib.commons.storage.*;

public class Cbact04cWorking extends NGroup {
  ...
  public Cvtra02y cvtra02y = new Cvtra02y();
  // COB:        01  DISCGRP-STATUS.
  public DiscgrpStatus discgrpStatus = new DiscgrpStatus();

  public static class DiscgrpStatus extends NGroup {

    // COB:            05 DISCGRP-STAT1        PIC X.
    public NChar discgrpStat1 = new NChar(1);
    // COB:            05 DISCGRP-STAT2        PIC X.
    public NChar discgrpStat2 = new NChar(1);
  }
  ...
  public static class Filler151 extends NGroup {
  ...
  public Filler151 filler151 = (Filler151) new Filler151().redefines(db2FormatTs);
  // COB:        01 WS-MISC-VARS.
  public WsMiscVars wsMiscVars = new WsMiscVars();

  public static class WsMiscVars extends NGroup {

    // COB:            05 WS-LAST-ACCT-NUM          PIC X(11) VALUE SPACES.
    public NChar wsLastAcctNum = new NChar(11).initial(NChar.Space);
    // COB:            05 WS-MONTHLY-INT            PIC S9(09)V99.
    public NZoned wsMonthlyInt = new NZoned(11, 2);
    // COB:            05 WS-TOTAL-INT              PIC S9(09)V99.
    public NZoned wsTotalInt = new NZoned(11, 2);
    // COB:            05 WS-FIRST-TIME             PIC X(01) VALUE 'Y'.
  ...
  public static class WsCounters extends NGroup {
    ...
    // COB:            05 WS-RECORD-COUNT           PIC 9(09) VALUE 0.
    public NZoned wsRecordCount = new NZoned(9, false).initial(0);
    // COB:            05 WS-TRANID-SUFFIX          PIC 9(06) VALUE 0.
    public NZoned wsTranidSuffix = new NZoned(6, false).initial(0);
  }
}
