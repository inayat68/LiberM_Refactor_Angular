...
public class Coadm01 extends NGroup {

  // COB:        01  COADM1AI.
  public static class Coadm1ai extends NGroup {
  ...
  public Coadm1ai coadm1ai = new Coadm1ai();

  // COB:        01  COADM1AO REDEFINES COADM1AI.
  public static class Coadm1ao extends NGroup {
    // COB:            02  FILLER PIC X(12).
  ...
  public Coadm1ao coadm1ao = (Coadm1ao) new Coadm1ao().redefines(coadm1ai);
}
