...
public class Cocrdup extends NGroup {

  // COB:        01  CCRDUPAI.
  public static class Ccrdupai extends NGroup {
    ...
    public Filler93 filler93 = (Filler93) new Filler93().redefines(expdayf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler99 filler99 = (Filler99) new Filler99().redefines(infomsgf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler105 filler105 = (Filler105) new Filler105().redefines(errmsgf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler111 filler111 = (Filler111) new Filler111().redefines(fkeysf);
    // COB:            02  FILLER   PICTURE X(4).
    public NChar filler113 = new NChar(4);
    // COB:            02  FKEYSI  PIC X(21).
    public NChar fkeysi = new NChar(21);
    // COB:            02  FKEYSCL    COMP  PIC  S9(4).
    public NInt16 fkeyscl = new NInt16();
    // COB:            02  FKEYSCF    PICTURE X.
    public NChar fkeyscf = new NChar(1);

    // COB:            02  FILLER REDEFINES FKEYSCF.
    public static class Filler117 extends NGroup {
      // COB:              03 FKEYSCA    PICTURE X.
      public NChar fkeysca = new NChar(1);
    }

    public Filler117 filler117 = (Filler117) new Filler117().redefines(fkeyscf);
    // COB:            02  FILLER   PICTURE X(4).
    public NChar filler119 = new NChar(4);
    // COB:            02  FKEYSCI  PIC X(18).
    public NChar fkeysci = new NChar(18);
  }

  public Ccrdupai ccrdupai = new Ccrdupai();

  // COB:        01  CCRDUPAO REDEFINES CCRDUPAI.
  public static class Ccrdupao extends NGroup {
    // COB:            02  FILLER PIC X(12).
    ...
    // COB:            02  FKEYSCC    PICTURE X.
    public NChar fkeyscc = new NChar(1);
    // COB:            02  FKEYSCP    PICTURE X.
    public NChar fkeyscp = new NChar(1);
    // COB:            02  FKEYSCH    PICTURE X.
    public NChar fkeysch = new NChar(1);
    // COB:            02  FKEYSCV    PICTURE X.
    public NChar fkeyscv = new NChar(1);
    // COB:            02  FKEYSCO  PIC X(18).
    public NChar fkeysco = new NChar(18);
  }

  public Ccrdupao ccrdupao = (Ccrdupao) new Ccrdupao().redefines(ccrdupai);
}
