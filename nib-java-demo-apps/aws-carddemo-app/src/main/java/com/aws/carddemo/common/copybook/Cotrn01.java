...
public class Cotrn01 extends NGroup {

  // COB:        01  COTRN1AI.
  public static class Cotrn1ai extends NGroup {
    ...
    public Filler57 filler57 = (Filler57) new Filler57().redefines(trnidinf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler63 filler63 = (Filler63) new Filler63().redefines(trnidf);
    // COB:            02  FILLER   PICTURE X(4).
    public NChar filler65 = new NChar(4);
    // COB:            02  TRNIDI  PIC X(16).
    public NChar trnidi = new NChar(16);
    ...
    public Filler69 filler69 = (Filler69) new Filler69().redefines(cardnumf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler75 filler75 = (Filler75) new Filler75().redefines(ttypcdf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler81 filler81 = (Filler81) new Filler81().redefines(tcatcdf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler87 filler87 = (Filler87) new Filler87().redefines(trnsrcf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler93 filler93 = (Filler93) new Filler93().redefines(tdescf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler99 filler99 = (Filler99) new Filler99().redefines(trnamtf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler105 filler105 = (Filler105) new Filler105().redefines(torigdtf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler111 filler111 = (Filler111) new Filler111().redefines(tprocdtf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler117 filler117 = (Filler117) new Filler117().redefines(midf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler123 filler123 = (Filler123) new Filler123().redefines(mnamef);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler129 filler129 = (Filler129) new Filler129().redefines(mcityf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler135 filler135 = (Filler135) new Filler135().redefines(mzipf);
    // COB:            02  FILLER   PICTURE X(4).
  ...
  public Cotrn1ai cotrn1ai = new Cotrn1ai();

  // COB:        01  COTRN1AO REDEFINES COTRN1AI.
  public static class Cotrn1ao extends NGroup {
    // COB:            02  FILLER PIC X(12).
    ...
    // COB:            02  TRNIDO  PIC X(16).
    public NChar trnido = new NChar(16);
    // COB:            02  FILLER PICTURE X(3).
  ...
  public Cotrn1ao cotrn1ao = (Cotrn1ao) new Cotrn1ao().redefines(cotrn1ai);
}
