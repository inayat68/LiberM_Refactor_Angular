...
public class Cousr02 extends NGroup {

  // COB:        01  COUSR2AI.
  public static class Cousr2ai extends NGroup {
  ...
  public Cousr2ai cousr2ai = new Cousr2ai();

  // COB:        01  COUSR2AO REDEFINES COUSR2AI.
  public static class Cousr2ao extends NGroup {
    // COB:            02  FILLER PIC X(12).
  ...
  public Cousr2ao cousr2ao = (Cousr2ao) new Cousr2ao().redefines(cousr2ai);
}
