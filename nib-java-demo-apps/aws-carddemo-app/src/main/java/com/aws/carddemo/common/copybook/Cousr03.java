...
public class Cousr03 extends NGroup {

  // COB:        01  COUSR3AI.
  public static class Cousr3ai extends NGroup {
    ...
    public Filler57 filler57 = (Filler57) new Filler57().redefines(usridinf);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler63 filler63 = (Filler63) new Filler63().redefines(fnamef);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler69 filler69 = (Filler69) new Filler69().redefines(lnamef);
    // COB:            02  FILLER   PICTURE X(4).
    ...
    public Filler75 filler75 = (Filler75) new Filler75().redefines(usrtypef);
    // COB:            02  FILLER   PICTURE X(4).
  ...
  public Cousr3ai cousr3ai = new Cousr3ai();

  // COB:        01  COUSR3AO REDEFINES COUSR3AI.
  public static class Cousr3ao extends NGroup {
    // COB:            02  FILLER PIC X(12).
  ...
  public Cousr3ao cousr3ao = (Cousr3ao) new Cousr3ao().redefines(cousr3ai);
}
