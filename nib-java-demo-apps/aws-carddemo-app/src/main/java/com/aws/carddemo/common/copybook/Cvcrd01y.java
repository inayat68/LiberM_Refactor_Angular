...
public class Cvcrd01y extends NGroup {
  ...
  // COB: 000100 01  CC-WORK-AREAS.
  public static class CcWorkAreas extends NGroup {
    // COB: 000200    05 CC-WORK-AREA.
    public static class CcWorkArea extends NGroup {
      // COB: 000900       10 CCARD-AID                         PIC X(5).
      public NChar ccardAid = new NChar(5);

      // COB: 001000          88  CCARD-AID-ENTER                VALUE 'ENTER'.
      ...
      // COB: 001100          88  CCARD-AID-CLEAR                VALUE 'CLEAR'.
      ...
      // COB: 001200          88  CCARD-AID-PA1                  VALUE 'PA1  '.
      ...
      // COB: 001300          88  CCARD-AID-PA2                  VALUE 'PA2  '.
      ...
      // COB: 001400          88  CCARD-AID-PFK01                VALUE 'PFK01'.
      ...
      // COB: 001500          88  CCARD-AID-PFK02                VALUE 'PFK02'.
      ...
      // COB: 001600          88  CCARD-AID-PFK03                VALUE 'PFK03'.
      ...
      // COB: 001700          88  CCARD-AID-PFK04                VALUE 'PFK04'.
      ...
      // COB: 001800          88  CCARD-AID-PFK05                VALUE 'PFK05'.
      ...
      // COB: 001900          88  CCARD-AID-PFK06                VALUE 'PFK06'.
      ...
      // COB: 002000          88  CCARD-AID-PFK07                VALUE 'PFK07'.
      ...
      // COB: 002100          88  CCARD-AID-PFK08                VALUE 'PFK08'.
      ...
      // COB: 002200          88  CCARD-AID-PFK09                VALUE 'PFK09'.
      ...
      // COB: 002300          88  CCARD-AID-PFK10                VALUE 'PFK10'.
      ...
      // COB: 002400          88  CCARD-AID-PFK11                VALUE 'PFK11'.
      ...
      // COB: 002500          88  CCARD-AID-PFK12                VALUE 'PFK12'.
      ...
      // COB: 002700       10  CCARD-NEXT-PROG                  PIC X(8).
      public NChar ccardNextProg = new NChar(8);
      // COB: 003300       10  CCARD-NEXT-MAPSET                PIC X(7).
      public NChar ccardNextMapset = new NChar(7);
      // COB: 003400       10  CCARD-NEXT-MAP                   PIC X(7).
      public NChar ccardNextMap = new NChar(7);
      // COB: 003800       10  CCARD-ERROR-MSG                  PIC X(75).
      public NChar ccardErrorMsg = new NChar(75);
      // COB: 003900       10  CCARD-RETURN-MSG                 PIC X(75).
      public NChar ccardReturnMsg = new NChar(75);

      // COB: 004000         88  CCARD-RETURN-MSG-OFF           VALUE LOW-VALUES.
      ...
      // COB: 004400       10 CC-ACCT-ID                        PIC X(11)
      ...
      // COB: 004600       10 CC-CARD-NUM                       PIC X(16)
      ...
      // COB: 004800       10 CC-CUST-ID                        PIC X(09)
      // COB: 004900                                            VALUE SPACES.
      public NChar ccCustId = new NChar(9).initial(NChar.Space);
      // COB: 004800       10 CC-CUST-ID-N REDEFINES CC-CUST-ID PIC 9(9).
