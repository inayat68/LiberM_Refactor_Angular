package com.aws.carddemo.online.program.storage.coadm01c;

import static com.nib.commons.storage.SpecialRegister.*;

import com.aws.carddemo.common.copybook.Coadm01;
import com.aws.carddemo.common.copybook.Coadm02y;
...
public class Coadm01cWorking extends NGroup {
  // COB:        01 WS-VARIABLES.
  public WsVariables wsVariables = new WsVariables();

  public static class WsVariables extends NGroup {

    // COB:          05 WS-PGMNAME                 PIC X(08) VALUE 'COADM01C'.
    public NChar wsPgmname = new NChar(8).initial("COADM01C");
    // COB:          05 WS-TRANID                  PIC X(04) VALUE 'CA00'.
    public NChar wsTranid = new NChar(4).initial("CA00");
    ...
    // COB:          05 WS-ADMIN-OPT-TXT           PIC X(40) VALUE SPACES.
    public NChar wsAdminOptTxt = new NChar(40).initial(NChar.Space);
  }

  public Cocom01y cocom01y = new Cocom01y();
  public Coadm02y coadm02y = new Coadm02y();
  public Coadm01 coadm01 = new Coadm01();
