package com.aws.carddemo.online.program.storage.copaus0c;

import com.aws.carddemo.common.copybook.Copau00;
...
public class Copaus0cWorking extends NGroup {
  ...
  public static class IrisWorkArea extends NGroup {
    ...
    public NChar irisProgramName = new NChar(8).initial("COPAUS0C");
  ...
  public static class WsVariables extends NGroup {
    ...
    // COB:          05 WS-PGM-MENU                PIC X(08) VALUE 'COMEN01C'.
    public NChar wsPgmMenu = new NChar(8).initial("COMEN01C");
    // COB:          05 WS-CICS-TRANID             PIC X(04) VALUE 'CPVS'.
    public NChar wsCicsTranid = new NChar(4).initial("CPVS");
    // COB:          05 WS-MESSAGE                 PIC X(80) VALUE SPACES.
    public NChar wsMessage = new NChar(80).initial(NChar.Space);
    // COB:          05 WS-ACCTFILENAME            PIC X(8)  VALUE 'ACCTDAT '.
    public NChar wsAcctfilename = new NChar(8).initial("ACCTDAT ");
    // COB:          05 WS-CUSTFILENAME            PIC X(8)  VALUE 'CUSTDAT '.
    public NChar wsCustfilename = new NChar(8).initial("CUSTDAT ");
    // COB:          05 WS-CARDFILENAME            PIC X(8)  VALUE 'CARDDAT '.
    public NChar wsCardfilename = new NChar(8).initial("CARDDAT ");
    // COB:          05 WS-CARDXREFNAME-ACCT-PATH  PIC X(8)  VALUE 'CXACAIX '.
    public NChar wsCardxrefnameAcctPath = new NChar(8).initial("CXACAIX ");
    // COB:          05 WS-CCXREF-FILE             PIC X(08) VALUE 'CCXREF  '.
    public NChar wsCcxrefFile = new NChar(8).initial("CCXREF  ");
    // COB:          05 WS-ACCT-ID                 PIC  X(11).
    public NChar wsAcctId = new NChar(11);
    // COB:          05 WS-AUTH-KEY-SAVE           PIC  X(08).
    public NChar wsAuthKeySave = new NChar(8);
    // COB:          05 WS-AUTH-APRV-STAT          PIC  X(01).
    public NChar wsAuthAprvStat = new NChar(1);
    ...
    // COB:          05 WS-RESP-CD-DIS             PIC  9(09).
    public NZoned wsRespCdDis = new NZoned(9, false);
    // COB:          05 WS-REAS-CD-DIS             PIC  9(09).
    ...
    // COB:          05 WS-DISPLAY-AMT12           PIC -zzzzzzz9.99.
    public NZoned wsDisplayAmt12 = new NZoned(12).formatAs("-#######0.00");
    // COB:          05 WS-DISPLAY-AMT9            PIC -zzzz9.99.
    public NZoned wsDisplayAmt9 = new NZoned(9).formatAs("-####0.00");
    // COB:          05 WS-DISPLAY-COUNT           PIC 9(03).
    public NZoned wsDisplayCount = new NZoned(3, false);
  ...
  public static class WsImsVariables extends NGroup {
    ...
    public static class PcbOffset extends NGroup {
      // COB:              10 PAUT-PCB-NUM                 PIC S9(4) COMP VALUE +1.
      public NInt16 pautPcbNum = new NInt16().initial(1);
    }
  ...
  // COB:        01  WS-SWITCHES.
  public WsSwitches wsSwitches = new WsSwitches();

  public static class WsSwitches extends NGroup {

    // COB:            05 WS-XREF-READ-FLG           PIC X(1).
    public NChar wsXrefReadFlg = new NChar(1);

    // COB:               88 ACCT-NFOUND-XREF                  VALUE 'N'.
    public boolean acctNfoundXref() {
      return wsXrefReadFlg.equals("N");
    }

    public void setAcctNfoundXref(boolean value) {
      if (value) wsXrefReadFlg.setValue("N");
    }

    // COB:               88 ACCT-FOUND-XREF                   VALUE 'Y'.
    public boolean acctFoundXref() {
      return wsXrefReadFlg.equals("Y");
    }

    public void setAcctFoundXref(boolean value) {
      if (value) wsXrefReadFlg.setValue("Y");
    }

    // COB:            05 WS-ACCT-MASTER-READ-FLG    PIC X(1).
    public NChar wsAcctMasterReadFlg = new NChar(1);

    // COB:               88 FOUND-ACCT-IN-MSTR                VALUE 'Y'.
    public boolean foundAcctInMstr() {
      return wsAcctMasterReadFlg.equals("Y");
    }

    public void setFoundAcctInMstr(boolean value) {
      if (value) wsAcctMasterReadFlg.setValue("Y");
    }

    // COB:               88 NFOUND-ACCT-IN-MSTR               VALUE 'N'.
    public boolean nfoundAcctInMstr() {
      return wsAcctMasterReadFlg.equals("N");
    }

    public void setNfoundAcctInMstr(boolean value) {
      if (value) wsAcctMasterReadFlg.setValue("N");
    }

    // COB:            05 WS-CUST-MASTER-READ-FLG    PIC X(1).
    public NChar wsCustMasterReadFlg = new NChar(1);

    // COB:               88 FOUND-CUST-IN-MSTR                VALUE 'Y'.
    public boolean foundCustInMstr() {
      return wsCustMasterReadFlg.equals("Y");
    }

    public void setFoundCustInMstr(boolean value) {
      if (value) wsCustMasterReadFlg.setValue("Y");
    }

    // COB:               88 NFOUND-CUST-IN-MSTR               VALUE 'N'.
    public boolean nfoundCustInMstr() {
      return wsCustMasterReadFlg.equals("N");
    }

    public void setNfoundCustInMstr(boolean value) {
      if (value) wsCustMasterReadFlg.setValue("N");
    }

    // COB:            05 WS-PAUT-SMRY-SEG-FLG       PIC X(1).
    public NChar wsPautSmrySegFlg = new NChar(1);

    // COB:               88 FOUND-PAUT-SMRY-SEG               VALUE 'Y'.
    public boolean foundPautSmrySeg() {
      return wsPautSmrySegFlg.equals("Y");
    }

    public void setFoundPautSmrySeg(boolean value) {
      if (value) wsPautSmrySegFlg.setValue("Y");
    }

    // COB:               88 NFOUND-PAUT-SMRY-SEG              VALUE 'N'.
    public boolean nfoundPautSmrySeg() {
      return wsPautSmrySegFlg.equals("N");
    }

    public void setNfoundPautSmrySeg(boolean value) {
      if (value) wsPautSmrySegFlg.setValue("N");
    }

    // COB:            05 WS-ERR-FLG                 PIC X(1)  VALUE 'N'.
    ...
    // COB:            05 WS-AUTHS-EOF               PIC X(1)  VALUE 'N'.
    ...
    // COB:            05 WS-SEND-ERASE-FLG          PIC X(1)  VALUE 'Y'.
  ...
  public static class CarddemoCommarea extends NGroup {
    ...
    // COB:           05 CDEMO-CPVS-INFO.
    public static class CdemoCpvsInfo extends NGroup {
      // COB:              10 CDEMO-CPVS-PAU-SEL-FLG     PIC X(01).
      public NChar cdemoCpvsPauSelFlg = new NChar(1);
      // COB:              10 CDEMO-CPVS-PAU-SELECTED    PIC X(08).
      public NChar cdemoCpvsPauSelected = new NChar(8);
      // COB:              10 CDEMO-CPVS-PAUKEY-PREV-PG  PIC X(08) OCCURS 20 TIMES.
      public NChar[] cdemoCpvsPaukeyPrevPg = AbstractNField.occurs(20, new NChar(8));

      public NChar cdemoCpvsPaukeyPrevPgAtIndex(int index) {
        return getOccursInstance(cdemoCpvsPaukeyPrevPg, index);
      }

      // COB:              10 CDEMO-CPVS-PAUKEY-LAST     PIC X(08).
      public NChar cdemoCpvsPaukeyLast = new NChar(8);
      // COB:              10 CDEMO-CPVS-PAGE-NUM        PIC S9(04) COMP.
      public NInt16 cdemoCpvsPageNum = new NInt16();
      // COB:              10 CDEMO-CPVS-NEXT-PAGE-FLG   PIC X(01) VALUE 'N'.
      public NChar cdemoCpvsNextPageFlg = new NChar(1);

      // COB:                 88 NEXT-PAGE-YES                     VALUE 'Y'.
      public boolean nextPageYes() {
        return cdemoCpvsNextPageFlg.equals("Y");
      }

      public void setNextPageYes(boolean value) {
        if (value) cdemoCpvsNextPageFlg.setValue("Y");
      }

      // COB:                 88 NEXT-PAGE-NO                      VALUE 'N'.
      public boolean nextPageNo() {
        return cdemoCpvsNextPageFlg.equals("N");
      }

      public void setNextPageNo(boolean value) {
        if (value) cdemoCpvsNextPageFlg.setValue("N");
      }

      // COB:              10 CDEMO-CPVS-AUTH-KEYS       PIC X(08) OCCURS 5 TIMES.
      public NChar[] cdemoCpvsAuthKeys = AbstractNField.occurs(5, new NChar(8));

      public NChar cdemoCpvsAuthKeysAtIndex(int index) {
        return getOccursInstance(cdemoCpvsAuthKeys, index);
      }
    }

    public CdemoCpvsInfo cdemoCpvsInfo = new CdemoCpvsInfo();
  }

  public Copau00 copau00 = new Copau00();
