package com.aws.carddemo.online.program.storage.cosgn00c;

import static com.nib.commons.storage.SpecialRegister.*;

import com.aws.carddemo.common.copybook.Cocom01y;
import com.aws.carddemo.common.copybook.Cosgn00;
...
public class Cosgn00cWorking extends NGroup {
  // COB:        01 WS-VARIABLES.
  public WsVariables wsVariables = new WsVariables();

  public static class WsVariables extends NGroup {

    // COB:          05 WS-PGMNAME                 PIC X(08) VALUE 'COSGN00C'.
    public NChar wsPgmname = new NChar(8).initial("COSGN00C");
    // COB:          05 WS-TRANID                  PIC X(04) VALUE 'CC00'.
    public NChar wsTranid = new NChar(4).initial("CC00");
    ...
    // COB:          05 WS-USER-ID                 PIC X(08).
    public NChar wsUserId = new NChar(8);
    // COB:          05 WS-USER-PWD                PIC X(08).
