package com.aws.carddemo.online.program.storage.cousr02c;

import static com.nib.commons.storage.SpecialRegister.*;

import com.aws.carddemo.common.copybook.Cottl01y;
import com.aws.carddemo.common.copybook.Cousr02;
...
public class Cousr02cWorking extends NGroup {
  // COB:        01 WS-VARIABLES.
  public WsVariables wsVariables = new WsVariables();

  public static class WsVariables extends NGroup {

    // COB:          05 WS-PGMNAME                 PIC X(08) VALUE 'COUSR02C'.
    public NChar wsPgmname = new NChar(8).initial("COUSR02C");
    // COB:          05 WS-TRANID                  PIC X(04) VALUE 'CU02'.
    public NChar wsTranid = new NChar(4).initial("CU02");
  ...
  public static class CarddemoCommarea extends NGroup {
    ...
    // COB:           05 CDEMO-CU02-INFO.
    public static class CdemoCu02Info extends NGroup {
      // COB:              10 CDEMO-CU02-USRID-FIRST     PIC X(08).
      public NChar cdemoCu02UsridFirst = new NChar(8);
      // COB:              10 CDEMO-CU02-USRID-LAST      PIC X(08).
      public NChar cdemoCu02UsridLast = new NChar(8);
      // COB:              10 CDEMO-CU02-PAGE-NUM        PIC 9(08).
      public NZoned cdemoCu02PageNum = new NZoned(8, false);
      // COB:              10 CDEMO-CU02-NEXT-PAGE-FLG   PIC X(01) VALUE 'N'.
      public NChar cdemoCu02NextPageFlg = new NChar(1).initial("N");

      // COB:                 88 NEXT-PAGE-YES                     VALUE 'Y'.
      public boolean nextPageYes() {
        return cdemoCu02NextPageFlg.equals("Y");
      }

      public void setNextPageYes(boolean value) {
        if (value) cdemoCu02NextPageFlg.setValue("Y");
      }

      // COB:                 88 NEXT-PAGE-NO                      VALUE 'N'.
      public boolean nextPageNo() {
        return cdemoCu02NextPageFlg.equals("N");
      }

      public void setNextPageNo(boolean value) {
        if (value) cdemoCu02NextPageFlg.setValue("N");
      }

      // COB:              10 CDEMO-CU02-USR-SEL-FLG     PIC X(01).
      public NChar cdemoCu02UsrSelFlg = new NChar(1);
      // COB:              10 CDEMO-CU02-USR-SELECTED    PIC X(08).
      public NChar cdemoCu02UsrSelected = new NChar(8);
    }

    public CdemoCu02Info cdemoCu02Info = new CdemoCu02Info();
  }

  public Cousr02 cousr02 = new Cousr02();
