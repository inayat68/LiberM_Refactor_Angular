package com.aws.carddemo.online.program.storage.irisutil;
...
public class IrisutilWorking extends NGroup {
  ...
  public static class WsJulianDate extends NGroup {
  ...
  public static class WsTime extends NGroup {
  ...
  public static class WsCurrentDatetime extends NGroup {
  ...
  public static class WsIoRtn extends NGroup {
    ...
    public static class Filler78 extends NGroup {
    ...
    // COB:          03 FILLER REDEFINES WS-IO-RTN-DBDNAME.
    public static class Filler84 extends NGroup {
      // COB:            05 FILLER                    PIC X(2).
  ...
  public static class IrisDliuib extends NGroup {

    // COB:          03 IRIS-UIBPCBAL               POINTER.
    public NPointer irisUibpcbal = new NPointer();

    // COB:          03 IRIS-UIBRCODE.
    public static class IrisUibrcode extends NGroup {
  ...
  public static class WsRunDbdStatusDecod extends NGroup {
  ...
  public static class Filler138 extends NGroup {
  ...
  public static class WsDbdLookupArea extends NGroup {

    // COB:          03 WS-DBD-LOOKUP-TABLE         OCCURS 255.
    public static class WsDbdLookupTable extends NGroup {
  ...
  public static class IrisIoAreas extends NGroup {
  ...
  public static class IrisBllCells extends NGroup {

    // COB:          03 IRIS-BLL-CELL               OCCURS 45.
    public static class IrisBllCell extends NGroup {
  ...
  public static class IrisPcbsArea extends NGroup {
    ...
    public static class IrisPcbsTab extends NGroup {
      ...
      public static class MemoryPcbArea extends NGroup {
        ...
        // COB:          07 DT-PSB-PCB.
        public static class DtPsbPcb extends NGroup {
      ...
      public static class IrisRntCntlArea extends NGroup {
        // COB:          07 RUN-RUN-FIXED.
        public static class RunRunFixed extends NGroup {
        ...
        // COB:          07 RUN-RUN-VAR.
        public static class RunRunVar extends NGroup {
          // COB:            09 RUN-SEGMENT-DETAIL OCCURS 16.
          public static class RunSegmentDetail extends NGroup {
            // COB:              11 RUN-USED-SSA-INFO.
            public static class RunUsedSsaInfo extends NGroup {
            ...
            public static class RunUsedKeysPsb extends NGroup {
              ...
              public static class RunUsedKeyValue extends NGroup {
                ...
                public static class RunLastSystemFldArea extends NGroup {
