 ...
 * @author nib-labs.io
 */
public abstract class NAsmBatchProgram extends AbstractProgram implements INAsmClonable {

  public NAsmBatchProgram(Context rt) throws NAsmException {
    super(rt);
  }
  ...
  protected static final Logger logger = LoggerFactory.getLogger(NAsmBatchProgram.class);
  ...
  protected static NAsmBatchProgram _CURRENT_INSTANCE = null;
...
//  }
   ...
   */
  public static NAsmBatchProgram getInstance() {
  ...
  protected NAsmField getStorage(int size) throws NAsmException {
    ...
    //fld.set(_LOW(size));
		NAsmEnvironment.registers[NAsmBatchProgram.REG_15].set(0); //SQ RC=0 from GETMAIN/SVC 10
    return fld;
  }
